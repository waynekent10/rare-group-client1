...
function User() {
  ...
  return (
    <article className="user">
      ...
      {users.map((aUser) => {
        console.log('from Index pre map: ***  ', 'first_name:', aUser.first_name, 'last_name:', aUser.last_name, 'bio:', aUser.bio, 'profile image url:', aUser.profile_image_url, 'email:', aUser.email, 'created_on:', aUser.created_on, 'active:', aUser.active, 'is_staff:', aUser.is_staff, 'id:', user.id);
        return (
